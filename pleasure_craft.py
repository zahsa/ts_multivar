...
if not os.path.exists(features_path_arima):
    ...
    features_arima = pd.read_csv(features_path_ou, index_col=0)
...
if not os.path.exists(features_path_var):
    ...
    features = pd.read_csv(features_path_ou, index_col=0)
...
print(normalized_mutual_info_score(result_ou_2.labels, result_arima_2.labels))
print(normalized_mutual_info_score(result_ou_3.labels, result_arima_3.labels))

print('ARIMA vs VAR')
# print(normalized_mutual_info_score(result_arima_1.labels, result_1.labels))
print(normalized_mutual_info_score(result_arima_2.labels, result_2.labels))
print(normalized_mutual_info_score(result_arima_3.labels, result_3.labels))

print('OU vs VAR')
# print(normalized_mutual_info_score(result_ou_1.labels, result_1.labels))
print(normalized_mutual_info_score(result_ou_2.labels, result_2.labels))
print(normalized_mutual_info_score(result_ou_3.labels, result_3.labels))